...
export default class CloudShader{
	makePlane(){
		var flim_noise = new THREE.TextureLoader().load("https://cdn.glitch.global/51da8aa6-2fd6-4cfa-afda-875afdda75a7/seamless-perlin-noise.jpg?v=1643971142731");
        var params={
            uniforms: {
            ...
            void main() {
                ...
                gl_FragColor = vec4(vec3(1.),(gl_FragColor.r * (1.-fogAmount))-.1);
...
shaderPlane.position.y += 110;
		shaderPlane.onBeforeRender=function(){
		    shaderMat.uniforms.uTime.value = performance.now() *.1
